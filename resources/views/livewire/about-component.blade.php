   ...
   <section class="about">
      ...
      <div class="content">
         ...
         <p>The Kaizen IT Institute is a trusted organization
            established with the goal of creating success in IT.
            Creative IT has achieved multifaceted success in the long
            13 years since its inception. Contributing to building a digital
            Bangladesh. One of the leading IT companies in Bangladesh has been
            playing an important role since 2007 in overcoming the unemployment
            problem.</p>
   ...
   <section class="about">
      ...
      <div class="content">
         <div class="icons-container">
            ...
            <div class="icons">
               <img src="{{asset('assets/images/books_icon_1.svg')}}" alt="">
               <div class="d-flex justify-content-center">
      ...
      {{-- <div class="swiper teachers-slider">
         ...
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">
               ...
               <div class="content">
                  <h3>Mohamed Nour</h3>
                  <span>expert Software Developer</span>
               </div>
            </div>
            ...
            <div class="swiper-slide slide">
               <div class="image">
                  <img src="{{asset('assets/images/teacher-5.png')}}" alt="">
                  <div class="share">
                     <a href="#" class="fab fa-facebook-f"></a>
                     <a href="#" class="fab fa-twitter"></a>
                     <a href="#" class="fab fa-instagram"></a>
            ...
            <div class="swiper-slide slide">
               <div class="image">
                  <img src="{{asset('assets/images/teacher-6.png')}}" alt="">
                  <div class="share">
                     <a href="#" class="fab fa-facebook-f"></a>
                     <a href="#" class="fab fa-twitter"></a>
                     <a href="#" class="fab fa-instagram"></a>
   ...
   <section class="reviews">
      ...
      <div class="swiper reviews-slider">
         ...
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">
               <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Enim animi atque numquam harum libero nemo,
                  eligendi laboriosam beatae quo iure corrupti, neque rerum possimus non nisi quia! Cumque, tempora sit.
               </p>
